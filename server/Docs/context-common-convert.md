...
```xml
<bean id="egovMessageSource" class="egov.com.cmm.EgovMessageSource">
...
```xml
<bean id="traceHandlerService" class="egov.rte.fdl.cmmn.trace.manager.DefaultTraceHandleManager">
